    ...
    return (
        <div className=" mb-10">
            ...
            <div>
                ...
                <div data-aos="zoom-in" className=" mx-auto sm:py-10 sm:pl-20 px-5 my-5 grid grid-cols-2 sm:grid-cols-3 sm:space-y-5 sm:gap-10 gap-5 sm:items-center sm:justify-center">
                    {
            ...
            <div>
                ...
                <div data-aos="zoom-in" className=" mt-10 grid sm:grid-cols-4 grid-cols-2 gap-5 sm:gap-20 sm:px-10 px-4 sm:py-10" >
                    {
