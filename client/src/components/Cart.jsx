    ...
    return (
        <div className=" sm:flex sm:space-x-10 px-5 space-y-5 sm:space-y-0 pb-10">
            <div className=" space-y-4">
                {
                    cart.map((product) => (
                        < div key={product._id} className=" bg-white shadow-xl flex items-center justify-between sm:space-x-10 sm:w-[729px] h-fit rounded p-1 sm:pr-4">
                            <div className=" flex items-center pr-4">
                                ...
                                <h1 className=" capitalize text-xs sm:text-base">{product.name}</h1>
                            </div>
                            <div className=" flex items-center">
                                <div className=" sm:pr-4 flex items-center sm:space-x-10 sm:space-y-2 text-center">
                                    <div>
