                ...
                <div className=" sm:flex bg-white shadow-xl rounded p-4 sm:space-x-10"> {/* i will modifie from div to form */}
                    ...
                    <div className=" relative pb-4 sm:pb-0 border-b sm:border-none">
                        <div className=" relative">
                            <img className=" sm:w-[300px] w-[150px] sm:h-[200px] mx-auto sm:mx-0 object-cover rounded-full" src={update.profilePic} alt={update.username} />
                            <label htmlFor="image"><svg className=" absolute sm:right-[80px] right-[139px] sm:top-[180px] top-[130px] fill-teal-500 bg-teal-100 rounded-full p-1 cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="2.5em" height="2.5em" viewBox="0 0 24 24"><path d="M19 7V5h-2V3h2V1h2v2h2v2h-2v2zm-8 10.5q1.875 0 3.188-1.312T15.5 13t-1.312-3.187T11 8.5T7.813 9.813T6.5 13t1.313 3.188T11 17.5m0-2q-1.05 0-1.775-.725T8.5 13t.725-1.775T11 10.5t1.775.725T13.5 13t-.725 1.775T11 15.5M3 21q-.825 0-1.412-.587T1 19V7q0-.825.588-1.412T3 5h3.15L8 3h7v4h2v2h4v10q0 .825-.587 1.413T19 21z"></path></svg></label>
                        </div>
